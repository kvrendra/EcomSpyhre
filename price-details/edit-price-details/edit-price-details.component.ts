...
export class EditPriceDetailsComponent implements OnInit {
  ...
  editById(id:any)
  {
    ...
    // this.serve.editUsingService(id,obj).subscribe((data:any)=>{console.log(data);
    // alert("{{id}} Record updated successfully")})
...
this.serve.editUsingService(id,obj2).subscribe((result)=>{console.log(result);this.router.navigate(['/view-price'])})
  }
